...
def review_list(request):
    ...
    return render(request, 'reviews/review_list1.html', context)


def review_detail(request, review_id):
    review = get_object_or_404(Review, pk=review_id)
    return render(request, 'reviews/review_detail1.html', {'review': review})


def book_list(request):
    book_list = Book.objects.order_by('-name')
    context = {'book_list':book_list}
    return render(request, 'reviews/book_list1.html', context)


def book_detail(request, book_id):
    book = get_object_or_404(Book, pk=book_id)
    form = ReviewForm()
    return render(request, 'reviews/book_detail1.html', {'book': book, 'form': form})
...
def user_review_list(request, username=None):
    ...
    return render(request, 'reviews/user_review_list1.html', context)
...
def user_recommendation_list(request):
    ...
    return render(
        request, 
        'reviews/user_recommendation_list1.html', 
